...
<table class="data"> 
	...
	<tr> 
		...
		<td><img class="img-mini" src="assets/foto/<?php echo $key['logo'];?>"></td> 
		...
		<td><a onclick="return confirm('Hapus Data<?php echo $key['nama'];?>')" <a href="proses/sekolah/hapus.php?id=<?php echo 
		$key['id'];?>">Hapus</a>
		</td> 
	</tr> 
	<?php 
